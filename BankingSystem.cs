...
class BankingSystem{
    ...
    static void Main(string[] args){
        ...
        SavingAccount account1= new SavingAccount(99887766,"Peter Parker",1998);
        CurrentAccount account2= new CurrentAccount(732892,"Iron Man",3000);
        accounts.Add(account1);
        accounts.Add(account2);
        account1.Deposit(7979);
